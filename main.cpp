...
//prototipos
void separarPorCategoria(FILE* , FILE*, FILE* );
...
int main() {
    ...
    separarPorCategoria(entrada, categoria1, categoria2);
...
void separarPorCategoria(FILE* entrada, FILE* categoria1, FILE* categoria2){
